...
@Repository
public interface RepositoryTeamDetail extends JpaRepository<AmericanFootballSpringBootModelTeamDetail, Long>
{
	AmericanFootballSpringBootModelTeamDetail findByTeamName(String teamName);
}
